...
vi.mock("./ingredient-create", () => ({
  ...
  queueIngredientCreate: vi.fn(),
}));
vi.mock("./ingredient-lifecycle", () => ({
  queueIngredientLifecycle: vi.fn(),
}));
vi.mock("./ingredient-version-publish", () => ({
  queueIngredientVersionPublish: vi.fn(),
}));
vi.mock("./ingredient-price-publish", () => ({
  queueIngredientPricePublish: vi.fn(),
}));
...
const catalog = {
  ingredients: [
    {
      ...
      currentPrice: {
        amount: "2.50",
        quantity: "1",
        unitId: "9ce17d2f-8365-4b1f-a80b-34d10425d51c",
        currency: "EUR",
      },
    },
  ],
  ...
  dietaryTags: [],
  storeSections: [
    { id: "ace17d2f-8365-4b1f-a80b-34d10425d51c", name: "Produce" },
  ],
...
describe("IngredientCatalog detail", () => {
  ...
  it("renders current, historical, price, and accessible back link", async () => {
    ...
    expect(
      screen.getByRole("link", { name: "Back to ingredient catalog" }),
    ).toHaveAttribute("href", `/organizations/${organizationId}/ingredients`);
    ...
    expect(
      screen.getByRole("list", { name: "Version history" }),
    ).toHaveTextContent("Old flour");
  });
  ...
  it("renders an unavailable state for an unknown selection", async () => {
    render(
      <IngredientCatalog
        ...
        userId={userId}
        onUnauthenticated={vi.fn()}
        selectedIngredientId="__invalid__"
      />,
    );
  ...
  it("fuzzy-filters active ingredients and gates retired results", async () => {
    readCatalog.mockResolvedValue({
      ...
      ingredients: [
        catalog.ingredients[0],
        {
          ...
          versionId: "9ce17d2f-8365-4b1f-a80b-34d10425d51c",
          name: "Sugar",
        },
        {
          ...catalog.ingredients[0],
          id: "ace17d2f-8365-4b1f-a80b-34d10425d51c",
          versionId: "bce17d2f-8365-4b1f-a80b-34d10425d51c",
          name: "Archived salt",
          retired: true,
        },
      ],
    ...
    fireEvent.click(
      screen.getByRole("checkbox", { name: "Show retired ingredients" }),
    );
