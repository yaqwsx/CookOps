  ...
  cs: {
    translation: {
      ...
      recipesCatalog: {
        ...
        newTagName: "Název nového štítku",
        tagColor: "Barva štítku",
        saveTag: "Uložit a vybrat štítek",
        tagCreateError: "Štítek je neplatný nebo již existuje.",
        tagFilter: "Filtrovat podle štítku",
        allTags: "Všechny štítky",
        saved: "Recept je uložen místně a bude synchronizován.",
        copy: "Kopírovat do jiné organizace",
        copyOnlineOnly: "Kopírování receptu vyžaduje připojení k internetu.",
        copyDestination: "Cílová organizace",
        copyChooseDestination: "Vyberte organizaci",
        copyLoading: "Načítáme závislosti receptu…",
        copyChooseMapping: "Vyberte mapování",
        copyConfirm: "Kopírovat recept",
        copySaved: "Recept byl zkopírován.",
        ...
        catalogUpdateUnavailable: "Podrobný náhled není v místní projekci k dispozici; aktualizaci nelze bezpečně použít.",
        catalogUpdateKinds: { added: "Přidáno", removed: "Odebráno", changed: "Změněno", preserved: "Zachováno" },
      ...
      ingredientsCatalog: {
        ...
        noStoreSections: "Pro vytvoření suroviny je potřeba aktivní oddělení obchodu.",
        ...
        copyNoMappings: "Všechna mapování byla vyřešena automaticky.",
        copySelectMapping: "Vyberte cílový záznam",
        copyCreateTag: "Vytvořit nový štítek",
        copyCancel: "Zrušit",
        copyConfirm: "Potvrdit kopírování",
        copyUnknownDependency: "Neznámá zdrojová závislost",
        copyRequirement: {
          canonical_unit: "Jednotka {{source}}",
          default_store_section: "Oddělení {{source}}",
          dietary_tag: "Dietní štítek {{source}}",
        },
        errors: {
          name: "Zadejte název do 200 znaků.",
      ...
      planner: {
        ...
        attendance: "Očekávaná účast",
        lifecycle: "Stav",
        pendingSync: "Synchronizace akce",
        ...
        createdAndScheduled: "Recept je uložen a přidán do plánu.",
        retrySchedule: "Zkusit přidání do plánu znovu",
        day: "Den",
        role: "Chod",
        recipe: "Recept",
        add: "Přidat do plánu",
      ...
      shopping: {
        ...
        fulfilled: "Nakoupeno",
        attribution: { note: "Nakoupil(a) {{actor}} · {{timestamp}}", you: "vy" },
        ...
        noFilteredRows: "Všechny položky odpovídají aktivnímu filtru.",
        hideCompleted: "Skrýt nakoupené a nepotřebné položky",
      ...
      synchronization: {
        ...
        recoverableDescription: "Tyto záměry byly odmítnuty. Exportujte je pro pozdější kontrolu, nebo je zahoďte. Zahození odstraní jen odmítnutý záměr; uložená data zůstanou beze změny.",
        unknownCommand: "Neznámá změna",
        export: "Exportovat JSON",
        discard: "Zahodit",
        discardConfirm: "Opravdu chcete odstranit tento odmítnutý záměr? Uložená data se nezmění.",
        close: "Zavřít",
        commandTypes: { "event.update": "Úprava akce", "recipe.create": "Vytvoření receptu", "recipe.publish_version": "Publikování receptu" },
      },
      authentication: {
  ...
  en: {
    translation: {
      ...
      recipesCatalog: {
        ...
        tagColor: "Tag color",
        saveTag: "Save and select tag",
        tagCreateError: "The tag is invalid or already exists.",
        tagFilter: "Filter by tag",
        allTags: "All tags",
        saved: "The recipe is saved locally and will synchronize.",
        copy: "Copy to another organization",
        copyOnlineOnly: "Recipe copying requires an internet connection.",
        copyDestination: "Destination organization",
        copyChooseDestination: "Choose an organization",
        copyLoading: "Loading recipe dependencies…",
        copyChooseMapping: "Choose a mapping",
        copyConfirm: "Copy recipe",
        ...
        catalogUpdateUnavailable: "The detailed preview is unavailable in the local projection; this update cannot be applied safely.",
        catalogUpdateKinds: { added: "Added", removed: "Removed", changed: "Changed", preserved: "Preserved" },
      ...
      ingredientsCatalog: {
        ...
        noStoreSections: "An active store section is required to create an ingredient.",
        ...
        copyNoMappings: "All mappings were resolved automatically.",
        copySelectMapping: "Choose a destination record",
        copyCreateTag: "Create a new tag",
        copyCancel: "Cancel",
        copyConfirm: "Confirm copy",
        copyUnknownDependency: "Unknown source dependency",
        copyRequirement: {
          canonical_unit: "{{source}} unit",
          default_store_section: "{{source}} store section",
          dietary_tag: "{{source}} dietary tag",
        },
        errors: {
          name: "Enter a name of at most 200 characters.",
      ...
      planner: {
        ...
        attendance: "Expected attendance",
        lifecycle: "Lifecycle",
        pendingSync: "Event synchronization",
        ...
        createdAndScheduled: "Recipe saved and added to the planner.",
        retrySchedule: "Retry adding to planner",
        day: "Day",
        role: "Meal role",
        recipe: "Recipe",
        add: "Add to planner",
      ...
      shopping: {
        ...
        fulfilled: "Purchased",
        attribution: { note: "Purchased by {{actor}} · {{timestamp}}", you: "You" },
        ...
        noFilteredRows: "All items match the active filter.",
        hideCompleted: "Hide purchased and unnecessary items",
      ...
      synchronization: {
        ...
        recoverableDescription: "These intents were rejected. Export them for later review, or discard them. Discarding removes only the rejected intent; cached data is unchanged.",
        unknownCommand: "Unknown change",
        export: "Export JSON",
        discard: "Discard",
        discardConfirm: "Discard this rejected intent? Cached data will not change.",
        close: "Close",
        commandTypes: { "event.update": "Event update", "recipe.create": "Recipe creation", "recipe.publish_version": "Recipe publication" },
      },
      authentication: {
