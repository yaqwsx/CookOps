...
class EventDayVisibilityPayload(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class EventDayNotePayload(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class EventMealRoleNamePayload(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class EventMealRoleLifecyclePayload(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
def _push_command(command: PushCommandRequest, organization_id: UUID) -> SyncCommand:
    try:
        ...
        if command.command_kind == "event_day.visibility":
            ...
            return SetEventDayVisibilityCommand(
                mutation_id=command.mutation_id,
                event_day_id=day_payload.event_day_id,
                organization_id=organization_id,
                event_id=day_payload.event_id,
        ...
        if command.command_kind == "event_meal_role.create":
            ...
            return CreateEventMealRoleCommand(
                mutation_id=command.mutation_id,
                event_meal_role_id=role_payload.event_meal_role_id,
                organization_id=organization_id,
        ...
        if command.command_kind == "event_meal_role.name":
            name_payload = EventMealRoleNamePayload.model_validate(command.payload)
            return SetEventMealRoleNameCommand(
                mutation_id=command.mutation_id,
                event_meal_role_id=name_payload.event_meal_role_id,
                organization_id=organization_id,
                event_id=name_payload.event_id,
                custom_name=name_payload.custom_name,
                client_wall_time=command.client_wall_time,
